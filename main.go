...
func (w Walking) Calories() float64 {
	...
	b := w.meanSpeed() * KmHInMsec
	a := math.Pow(b, 2)
	return ((CaloriesWeightMultiplier*w.Weight + (a/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
